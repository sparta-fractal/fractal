...
import com.sparta.team5.fractal.domain.product.service.ProductServiceV1;
...
public class ProductControllerV1 {
    ...
    public ResponseEntity<ApiResponse<ProductResponse>> createProduct(@Valid @RequestBody ProductCreateRequest request) {
        ...
        ProductResponse productResponse = productServiceV1.createProduct(request);
    ...
    public ResponseEntity<ApiResponse<ProductResponse>> getProduct(@PathVariable Long productId) {
        ...
        ProductResponse productResponse = productServiceV1.getProduct(productId);
    ...
    public ResponseEntity<ApiResponse<ProductListResponse>> getProductsByKeyword(
        ...
        ProductListResponse productListResponse = productServiceV1.getProductsByKeyword(pageable, keyword);
